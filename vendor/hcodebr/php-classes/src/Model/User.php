...
Class User extends Model {
    ...
    public static function getForgot($email, $inadmin = true) 
    {
        ...
        $results = $sqlData->select("SELECT * FROM tb_persons a INNER JOIN tb_users b USING (idperson) WHERE a.desemail = :email", array(
            ":email"=>$email
        ));
        ...
        else 
        {
            ...
            else 
            {
                ...
                else 
                {
                    ...
                    $mailer = new Mailer($data["desmail"], $data["desperson"], "Redefinição de senhora Hcode Store", "forgot", 
                        array(
                            "name"=>$data["desperson"],
                            "link"=>$link
