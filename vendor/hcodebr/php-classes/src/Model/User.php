    ...
    public static function getForgot($email, $inadmin = true)
{
     ...
     {
         $data = $results[0];
         $results2 = $sqlData->select("CALL sp_userspasswordsrecoveries_create(:iduser, :desip)", array(
             ":iduser"=>$data['iduser'],
         ...
         else
         {
             ...
             if ($inadmin === true) {
                 $link = "http://www.crudecommerce.com.br/admin/forgot/reset?code=$result";
             } else {
                 $link = "http://www.crudecommerce.com.br/forgot/reset?code=$result";
             } 
 ...
 public static function setForgotUsed($idrecovery)
 {
    ...
    $sqlData->query("UPDATE tb_userspasswordsrecoveries SET dtrecovery = NOW() WHERE idrecovery = :idrecovery", array(
        ":idrecovery"=>$idrecovery
    ));
 ...
 public function setPassword($password)
 {
    ...
    $sqlData->query("UPDATE tb_users SET despassword = :password WHERE iduser = :iduser", array(
        ":password"=>$password,
        ":iduser"=>$this->getiduser()
    ));
